    ...
    <div class="container">
        ...
        <div class="form-container">
            <form method="POST" id="loginForm" class="form" action="../controller/authController.php?action=login">
                ...
                <p>¿Olvidaste tu contraseña? <a href="forgot_password.html">Recupérala aquí</a></p>
            ...
            <form id="registerForm" class="form hidden" action="../controller/authController.php?action=register"
                ...
                <input type="password" id="registerPassword" name="clave" placeholder="Introduce tu contraseña"
                    required>
