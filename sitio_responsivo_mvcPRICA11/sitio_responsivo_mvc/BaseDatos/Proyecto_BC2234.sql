...
insert into permiso(id_permiso, nombre) values ('1','editar_info_perfil'), ('2','subir_publicidad_empresas'),('3','subir_sitios_empresas'),('4','eliminar_sitios_empresas'), 
('5','subir_sitiosturisticos'), ('6','eliminar_usuario');
select * from permiso;
